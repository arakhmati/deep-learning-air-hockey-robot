...
if __name__ == "__main__":
    ...
    callbacks = []
    callbacks.append(EarlyStopping(monitor='val_loss', min_delta=0.0001, patience=100, verbose=1, mode='auto'))
#    callbacks.append(TensorBoard(log_dir='./Graph', histogram_freq=1, write_graph=True, write_images=True))
